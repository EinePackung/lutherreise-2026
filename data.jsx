...
const TAGE = [
  ...
  },
  {
    ...
    items: [
      { zeit: '8:45',  titel: 'Treffen in der Gemeinde',     note: '' },
      { zeit: '9:15',  titel: 'Abfahrt & Frühstück im Auto', note: 'Brötchen unterwegs' },
      { zeit: '10:45', titel: 'Ankunft Wittenberg',          note: '' },
      { zeit: '11:15', titel: 'Schlosskirche',               note: 'Andacht zu den 95 Thesen', highlight: true },
      { zeit: '12:05', titel: 'Stadtkirche St. Marien',      note: '' },
      { zeit: '12:45', titel: 'Mittagspause',                note: 'Sandwich am Marktplatz' },
      { zeit: '14:15', titel: 'Cranach-Hof',                 note: 'Cranach-Höfe · Ort des Buchdrucks' },
      { zeit: '15:00', titel: 'Luthereiche',                 note: 'Verbrennung der Bannandrohungsbulle', highlight: true },
      { zeit: '15:25', titel: 'Lutherhaus / Augusteum',      note: 'Augusteum (Lutherhaus-Sanierung)', highlight: true },
      { zeit: '',      titel: 'Freizeit',                    note: 'Falls die Zeit es erlaubt · Luther 1517 360° · Melanchthonhaus' },
...
const GRUPPEN = [
  ...
  { nr: 3, leiter: 'B. Youngwoong', mit: ['B. Poeun', 'S. Joycee', 'S. Hyunji', 'S. Nayoung', 'S. Pagmaa', 'S. Xi'] },
  { nr: 4, leiter: 'B. Wonmin',    mit: ['B. Martin', 'S. Lena', 'S. Yujeong', 'S. Haneul', 'S. Michelle', 'S. Hanna'] },
];
